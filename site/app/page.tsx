  ...
  return (
    <div className="space-y-16">
      ...
      <section className="h-screen flex flex-col justify-center items-center text-center space-y-4">
        <h1 className="text-6xl text-gray-900 dark:text-[#D4AF37]">
          Adam Makhyoun
        </h1>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-6xl mx-auto grid gap-8 md:grid-cols-2">
            <ProjectCard
              ...
              video="/images/flipping99-demo.mp4"
              thumbnail="/images/flipping99-placeholder.png"
              appStoreUrl="https://apps.apple.com/us/app/flipping99/id6749456231"
            ...
            <ProjectCard
              ...
              link="https://github.com/boxingdaddev/flashcard-AI-app"
              video="/images/aiflashcards-demo.mp4"
      ...
      <section className="px-6 pt-16">
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            "AsyncStorage",
            "API Integration",
            "Firebase/Supabase (Planned)",
          ].map((skill) => (
            <span
              key={skill}
              className="px-3 py-1 bg-gray-200 dark:bg-gray-800 rounded-full text-sm text-[#6B7280] dark:text-[#93B8BF]"
            >
              {skill}
            </span>
          ))}
      ...
      <section className="px-6 pt-16 mb-16">
        ...
        <p>
          Email:{" "}
          <a
            href="mailto:adamscope@gmail.com"
        ...
        <p>
          GitHub:{" "}
          <a
            href="https://github.com/boxingdaddev"
            target="_blank"
            className="text-blue-500 underline"
          >
            github.com/boxingdaddev
          </a>
        </p>
      </section>
    </div>
